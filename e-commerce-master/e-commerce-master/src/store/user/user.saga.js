...
export function* onSignUpSuccesss(){
...
export function* userSagas() {
    yield all([call(onCheckUserSession), call(onGoogleSignIn), call(onEmialSignInStart), call(onSignUpStart), call(onSignUpSuccesss), call(onSignOutStart)])
}